import { ClassForm, ClassList, Home, Login, SignUp, StudentForm, StudentList, SubjectForm, SubjectList, SyllabusForm, SyllabusList, TeacherForm, TeacherList } from './AllPages';
import './App.css'
