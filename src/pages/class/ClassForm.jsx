...
function ClassForm() {
  ...
  return (
    <div className='max-w-[600px] m-auto py-10'>
      ...
      <button disabled={buttonDisable}  className={`bg-gradient-to-r from-green-600 to-blue-600 text-white py-1 rounded-sm ${buttonDisable ? "bg-pink-600":""}`}>Sumbit</button>
      </form>
    </div>
  )
}
