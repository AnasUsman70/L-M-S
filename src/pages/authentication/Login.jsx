...
const Login= () => {
  ...
  return (
    <div className="bg-gradient-to-r from-green-600 to-blue-600 h-screen font-popins py-20 px-2">
      <div className="max-w-[400px]  border m-auto bg-white px-3 flex flex-col gap-5 py-5 rounded-sm shadow-lg">
        ...
        <div className="w-full flex gap-1">
          <div className="w-6/12">
            <button
              className={`w-full py-2 rounded-[4px] transition-all duration-500  bg-gradient-to-r from-green-600 to-blue-600 text-white  border hover:bg-gradient-to-r hover:from-green-600 hover:to-blue-600 hover:text-white"}`}
            >
              Login
            </button>
          </div>
          <div className="w-6/12">
            <button
              ...
              className={`w-full  py-2 rounded-[4px] transition-all duration-500 border hover:bg-gradient-to-r hover:from-green-600 hover:to-blue-600 hover:text-white `}
            >
              Sign up
            </button>
          </div>
        ...
        <div className="w-full">
          <button className="bg-gradient-to-r from-green-600 to-blue-600 w-full py-2 text-white font-semibold">
            Login 
          </button>
        </div>
        ...
        <div className="flex justify-center flex-col sm:flex-row">
          ...
          <NavLink to="/sign-up" className="text-green-700 cursor-pointer text-center hover:text-blue-600">
            sign up Now
          </NavLink>
        </div>
