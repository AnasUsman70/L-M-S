    ...
    <div className="bg-gradient-to-r from-green-600 to-blue-600 h-screen font-popins py-20 px-2">
      <div className="max-w-[400px]  border m-auto bg-white px-3 flex flex-col gap-5 py-5 rounded-sm shadow-lg">
        ...
        <div className="w-full">
          <button className="bg-gradient-to-r from-green-600 to-blue-600 w-full py-2 text-white">
            Sign up
          </button>
        </div>
        ...
        <div className="flex justify-center flex-col sm:flex-row">
          ...
          <NavLink to="/login" className="text-green-700 cursor-pointer text-center hover:text-blue-600">
            Login Now
          </NavLink>
        </div>
      </div>
